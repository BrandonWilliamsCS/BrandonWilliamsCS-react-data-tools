...
/**
 * Switches over the possible statuses of a AsyncStatus and renders the
 ...
 */
export function AsyncStatusGate<T, E = any>({
  status,
  children,
  errorContent,
  pendingContent,
}: AsyncStatusGateProps<T, E>) {
...
export interface AsyncStatusGateProps<T, E> {
  status: AsyncStatus<T, E> | undefined;
